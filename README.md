...
* Cloning into VM and starting VM as web server
* Running a VM as simple webserver for testing
* Host it on any local / remove PC and do load/performance testing
